package com.luoye.whr.gallery.view.home
...
import com.luoye.whr.gallery.view.home.recomment.RecommendFragment
import com.luoye.whr.gallery.view.base.BaseControlFragment
import com.luoye.whr.gallery.view.home.follow.FollowFragment
import com.luoye.whr.gallery.view.home.like.LikeFragment
import com.luoye.whr.gallery.view.home.rank.RankFragment
import com.luoye.whr.gallery.view.login.LoginActivity
import com.luoye.whr.gallery.view.search.SearchActivity
...
class HomeActivity : PermissionBaseActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    fun addSharedCallback(callback: ((names: MutableList<String>,
                                      sharedElements: MutableMap<String, View>) -> Unit)) {
        if (!sharedElementsCallList.contains(callback)) {
            sharedElementsCallList.add(callback)
        }
    }

    fun removeSharedCallback(callback: ((names: MutableList<String>,
                                         sharedElements: MutableMap<String, View>) -> Unit)) {
