...
import com.luoye.whr.gallery.api.PixivImageApi
import com.luoye.whr.gallery.api.PixivUserApi
import com.luoye.whr.gallery.common.BASE_URL
import com.luoye.whr.gallery.common.PIXIV_SECURE
...
object PixivImageModel {
     ...
     * 搜索
     */
    fun getSearch(word: String, sort: String, search_target: String, bookmark_num: Int? = null,
                  duration: String? = null, Authorization: String) = api.getSearchIllust(word, sort,
