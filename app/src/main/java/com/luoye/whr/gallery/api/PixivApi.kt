package com.luoye.whr.gallery.api
...
interface PixivImageApi {
    ...
    fun getList(@Header("Authorization") auth: String,
                @Query("date") date: String,
                @Query("mode") mode: String): Call<ResponseBody>
    ...
    fun getNext(@Header("Authorization") paramString1: String,
                @Url paramString2: String): Call<ResponseBody>
    ...
    fun getSearchIllust(@Query("word") word: String,
    ...
    fun getSearchUser(@Header("Authorization") paramString1: String,
                      @Query("word") paramString2: String): Call<ResponseBody>
    ...
    fun getFollowIllusts(@Header("Authorization") paramString1: String,
                         @Query("restrict") paramString2: String): Call<ResponseBody>
    ...
    fun getLikeIllust(@Header("Authorization") paramString1: String,
                      ...
                      @Query("tag") paramString3: String?): Call<ResponseBody>
...
interface PixivUserApi {
    ...
    @FormUrlEncoded
    @POST("/auth/token")
    fun postAuthToken(@Field("client_id") client_id: String,
    ...
    fun refreshToken(@Field("client_id") client_id: String,
                     ...
                     @Field("get_secure_url") get_secure_url: Boolean,
                     @Field("grant_type") grant_type: String,
                     @Field("refresh_token") refresh_token: String): Call<ResponseBody>
}